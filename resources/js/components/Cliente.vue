    ...
    export default {
        ...
        methods:{
           ...
           registrarCliente(){
               ...
               axios.post('/cliente/registrar', body).then(function (response) {
                    // handle success
                    //console.log(response);
                    me.cerrarModal();
            ...
            actualizarCliente(){
               ...
               axios.put('/cliente/actualizar', body).then(function (response) {
                    // handle success
                    console.log(response);
                    me.cerrarModal();
                    me.listarCliente(1,'','nombre');
            ...
            validarCliente(){
                ...
                if (!this.nombre) this.errorMostrarMsjCliente.push("(*)El nombre del clienteno puede estar vacío.");
